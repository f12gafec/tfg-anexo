        ...
        match estimator_name:
            ...
            case "randomforestclassifier":
                ...
                param_grid = {
                    ...
                    "max_features": ["sqrt"],
                    "criterion": ["gini", "entropy"],  # <--- Nuevo
                    "ccp_alpha": [0.0, 0.001, 0.01]    # <--- La joya de la corona contra el overfitting
                }
            ...
            case "rotationforestclassifier":               
                # 1. Definimos un árbol "frenado" para que no memorice el ruido


                # 2. Añadimos el árbol base al grid principal
                base_grid = {
                    "random_state": random_state,
                }

                # 3. Ampliamos las combinaciones para encontrar el modelo ideal
                param_grid = {
                    "n_estimators": [100, 200, 500], # Corregido el salto numérico
        ...
        match estimator_name:
            ...
            case "mlpbetaclassifier":
                ...
                param_grid = {
                 ...
                 # Eliminamos 1e-1 que suele desestabilizar a Adam
                    "learning_rate": [1e-2, 5e-3, 1e-3, 1e-4],
                    
                    # Tu parámetro específico para mlpbetaclassifier
                    "loss_eta": [0.1, 0.2, 0.4, 0.6, 0.8],
                    
                    # Regularización L2 para evitar overfitting
                    "weight_decay": [0.0, 1e-4, 1e-3],

                    "batch_size": [254, 512, 1024]
                }
            ...
            case "mlptriangularclassifier":
                ...
                param_grid = {
                    ...
                    "learning_rate": [1e-2, 5e-3, 1e-3, 1e-4],
                    "loss_alpha2": [0.125, 0.025, 0.05, 0.1, 0.15],
                    "loss_eta": [0.1, 0.2, 0.4, 0.6, 0.8],
                    "weight_decay": [0.0, 1e-4, 1e-3],
                    "batch_size": [256, 512, 1024]
                }
